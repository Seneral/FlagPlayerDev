...
function ct_loadPreferences () {
	...
	// Cache
	ct_pref.cacheAudioQuality = G("prefCacheAudioQuality") || "120";
...
function db_getVideo (videoID, callback) {
	db_access (function () {
		db_database.transaction("videos", "readonly")
		.objectStore("videos")
		.get(videoID).onsuccess = function (e) {
